...
TruckingCompany[0] = {["x"] = 497.19439697266 ,["y"] = -1967.6551513672, ["z"] = 23.881172180176}
local TruckingTrailer = {}
TruckingTrailer[0] = {["x"] = 488.16653442383, ["y"] = -1994.603515625, ["z"] = 23.979108810425, ["heading"] = 35.50569152832}
...
local MissionData = {
    ...
    [1] = {2574.5144, 328.5554, 108.45, 6500},
    [2] = {-2565.0894, 2345.8904, 33.06, 7500},
    [3] = {1706.7966, 4943.9897, 42.16, 10000},
    [4] = {196.5617, 6631.0967, 31.53, 15000},
...
function tick()
    ...
    if( GetDistanceBetweenCoords( playerCoords, TruckingCompany[0]["x"], TruckingCompany[0]["y"], TruckingCompany[0]["z"] ) < 100) then
        DrawMarker(1,TruckingCompany[0]["x"],TruckingCompany[0]["y"],TruckingCompany[0]["z"],0,0,0,0,0,0,5.001,5.001,0.5001,0,155,255,200,0,0,0,0)
    end
...
function MISSION.spawnTruck()
    ...
    MISSION.truck = CreateVehicle(MISSION.hashTruck, 475.14028930664, -1969.5570068359,23.657121658325, 34.894931793213, true, false)
...
function MISSION.spawnTrailer()
    MISSION.trailer = CreateVehicle(MISSION.hashTrailer, TruckingTrailer[0]["x"], TruckingTrailer[0]["y"], TruckingTrailer[0]["z"], TruckingTrailer[0]["heading"], true, false)
    SetVehicleOnGroundProperly(MISSION.trailer)
...
function GUI.init()
    ...
    GUI.addButton(1, "Mission 2 [ $6,500 ]", GUI.mission, 0.35, 0.30, 0.3, 0.05)
    GUI.addButton(1, "Mission 3 [ $7,500 ]", GUI.mission, 0.35, 0.35, 0.3, 0.05)
    GUI.addButton(1, "Mission 4 [ $10,000 ]", GUI.mission, 0.35, 0.40, 0.3, 0.05)
    GUI.addButton(1, "Mission 5 [ $15,000 ]", GUI.mission, 0.35, 0.45, 0.3, 0.05)
    GUI.addButton(1, " ", GUI.null, 0.35, 0.50, 0.3, 0.05)
