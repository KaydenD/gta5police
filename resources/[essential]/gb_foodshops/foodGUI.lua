...
function ShopMenu()
	ClearMenu()
		Menu.addTitle("MENU")
		Menu.addButton("Big Gulp","buymenu",{6, 1, 3, 1})
		Menu.addButton("Corn Dog","buymenu",{5, 1, 6, 1})
		Menu.addButton("Vodka","buymenu",{3, 1, 20, 1})
		Menu.addButton("Repair Kit","buymenu",{31, 1, 500, 10})
--		Menu.addButton("FoodName","buymenu",{ itemId, qty, price, weight}) -- itemId = id de l'item vdk (Table : items), qty = quantité et price = prix
end
