...
function ShopMenu()
	ClearMenu()
		Menu.addTitle("MENU")
		Menu.addButton("Class 1 Weapon License $10,000","buymenu",{1, 10000})
		Menu.addButton("Class 2 Weapon License $15,000","buymenu",{2, 15000})
		--Menu.addButton("Class 3 Weapon License $50,000","buymenu",{3, 50000})
...
function buymenu(fooditem)
	TriggerServerEvent('kk:buyLicense', fooditem)
end
