local jobmenu = {
  ...
  menu = {
    ...
    ["main"] = {
      ...
      name = "main",
      buttons = {
        --{title = "Jew", name = "Jew", id = 2},
        {title = "Lawyer", name = "Lawyer", id = 3},
        {title = "Sulfur Miner", name = "Sulfur Miner", id = 4}, -- ENGLISH : Minor
        {title = "Taxi Driver", name = "Taxi Driver", id = 5}, -- ENGLISH : Fisherman
        {title = "Oil Manufacturer", name = "Oil Manufacturer", id = 12},
        {title = "Garbage Man", name = "Garbage Man", id = 13},
        {title = "Trucker", name = "Trucker", id = 14},
        {title = "Fisherman", name = "Fisherman", id = 15},
        {title = "Iron Miner", name = "Iron Miner", id = 16},
        {title = "Security Guard", name = "Security Guard", id = 17},
        {title = "Janitorial Supplies Salesman", name = "Janitorial Supplies Salesman", id = 19},
        {title = "Alderman", name = "Alderman", id = 20},
...
function ShowJobBlips(bool)
  if bool and #jobmenu_blips == 0 then
    for station,pos in pairs(jobmenu_locations) do
      ...
      AddTextComponentString('Employment Office')
    ...
    Citizen.CreateThread(function()
      while #jobmenu_blips > 0 do
        ...
        for i,b in ipairs(jobmenu_blips) do
            ...
            DisplayHelpText("Press enter to choose your jobs!")
            currentlocation = b
            inrange = true
          end
        end
