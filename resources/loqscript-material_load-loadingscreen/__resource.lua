...
files {
    ...
    'LoadingScreen/images/blackjesus.jpg',
    'LoadingScreen/images/Detroit_wallpaper_2166.jpg',
    --Loading Audio Files--
    'LoadingScreen/audio/loadingmusic.ogg',
    'LoadingScreen/audio/intromusic.ogg',
    'LoadingScreen/audio/wiimusic.ogg',
    --Loading Config File--
